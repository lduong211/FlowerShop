...
namespace FlowerShop.Models
{
	...
	public partial class dbFlowerShopDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void InsertTHIETKE(THIETKE instance);
    partial void UpdateTHIETKE(THIETKE instance);
    partial void DeleteTHIETKE(THIETKE instance);
    ...
    partial void DeleteHOA(HOA instance);
		...
		public dbFlowerShopDataContext() : 
		...
		public dbFlowerShopDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public dbFlowerShopDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public dbFlowerShopDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public dbFlowerShopDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<THIETKE> THIETKEs
		{
			get
			{
				return this.GetTable<THIETKE>();
			}
		}
	...
	public partial class ADMIN
	{
		...
		private System.Nullable<int> _MaAd;
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MaAd", DbType="Int")]
		public System.Nullable<int> MaAd
		{
			get
			{
				return this._MaAd;
    ...
    partial void OnTenChuDeChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="CHUDE_HOA", Storage="_HOAs", ThisKey="MaCD", OtherKey="MaCD")]
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.THIETKE")]
	public partial class THIETKE : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnKieuThietKeChanging(string value);
    partial void OnKieuThietKeChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_KieuThietKe", DbType="NVarChar(30) NOT NULL", CanBeNull=false)]
		public string KieuThietKe
		{
			get
			{
				return this._KieuThietKe;
			}
			set
			{
				if ((this._KieuThietKe != value))
				{
					this.OnKieuThietKeChanging(value);
					this.SendPropertyChanging();
					this._KieuThietKe = value;
					this.SendPropertyChanged("KieuThietKe");
					this.OnKieuThietKeChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="THIETKE_HOA", Storage="_HOAs", ThisKey="MaTK", OtherKey="MaTK")]
		public EntitySet<HOA> HOAs
		{
			get
			{
	...
	public partial class HOA : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<THIETKE> _THIETKE;
    ...
    partial void OnMaCDChanged();
		...
		public HOA()
		{
			...
			this._THIETKE = default(EntityRef<THIETKE>);
			OnCreated();
		}
		...
		public System.Nullable<int> MaTK
		{
			...
			set
			{
				if ((this._MaTK != value))
				{
					if (this._THIETKE.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnMaTKChanging(value);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="CHUDE_HOA", Storage="_CHUDE", ThisKey="MaCD", OtherKey="MaCD", IsForeignKey=true, DeleteRule="CASCADE")]
		public CHUDE CHUDE
		{
			get
			{
		...
		public THIETKE THIETKE
		{
			get
			{
				return this._THIETKE.Entity;
			}
			set
			{
				THIETKE previousValue = this._THIETKE.Entity;
				if (((previousValue != value) 
							|| (this._THIETKE.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._THIETKE.Entity = null;
						previousValue.HOAs.Remove(this);
					}
					this._THIETKE.Entity = value;
					if ((value != null))
					{
						value.HOAs.Add(this);
